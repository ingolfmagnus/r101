...
/**
 * A class to read a map from a file. After the file is read, the map
 * is stored as an {@link #IGrid} whose entries are characters. This
 * can then be used to be passed to the constructor in {@link #BDMap}.
 *
